import { Component, OnInit, OnChanges, DoCheck, EventEmitter, SimpleChanges } from '@angular/core';
import RatingOption from './rating.options';

@Component({
  selector: 'alife-rating-star',
  templateUrl: './alife-rating-star.component.html',
  styleUrls: ['./alife-rating-star.component.css'],
  inputs: ['options', 'rating'],
  outputs: ['onRatingChanged', 'ratingChange']
})
export class AlifeRatingStarComponent implements OnInit, OnChanges, DoCheck {
